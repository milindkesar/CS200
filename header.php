...
<!-- <h1>My forum</h1> -->
    ...
    <nav id="wrapper" class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          <a class="navbar-brand ">Pied Piper</a>
        </div>
        ...
        <li><a href="#"><span class="glyphicon glyphicon-user"></span>Hey Example</a></li>
            <li><a id="userbar" href="#"><span class="glyphicon glyphicon-log-in"></span> Log out</a></li>
        </ul>
      </div>
